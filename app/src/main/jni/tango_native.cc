...
Java_com_projecttango_experiments_nativehellotango_TangoJNINative_connectCallbacks(
        JNIEnv*, jobject) {
    return static_cast<int>(tango_handler.ConnectCameraCallback());
}
...
JNIEXPORT void JNICALL
Java_com_projecttango_experiments_nativehellotango_TangoJNINative_writeToFile(
        JNIEnv*, jobject) {
tango_handler.writeToFile();
}

JNIEXPORT void JNICALL
Java_com_projecttango_experiments_nativehellotango_TangoJNINative_startCameraProcess(
        JNIEnv*, jobject) {
tango_handler.startCameraProcess();
}

JNIEXPORT void JNICALL
Java_com_projecttango_experiments_nativehellotango_TangoJNINative_stopCameraProcess(
        JNIEnv*, jobject) {
tango_handler.stopCameraProcess();
}
